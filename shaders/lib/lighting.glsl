...
vec3 nexSunColor(){vec3 noon = vec3(1.10, 1.00, 0.84); vec3 low = vec3(1.00, 0.54, 0.30); return mix(low, noon, nexDayFactor()) * (1.0 - rainStrength * 0.35);}
vec3 nexTorchColor(float blockLight){return vec3(1.00, 0.60, 0.30) * (blockLight * blockLight) * 1.10;}
